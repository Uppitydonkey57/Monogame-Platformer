...
namespace Platformer.Editor.WinFormsUI
{
    public abstract class GraphicsDeviceControl : GLControl
    {
        ...
        protected abstract void PaintUsingSystemDrawing(System.Drawing.Graphics graphics, string beginDrawError);
        ...
        protected virtual void PaintUsingSystemDrawing (GraphicsDevice graphics, string text)
        {
